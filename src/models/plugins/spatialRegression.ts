...
import { isSpatialWeightsParam, makeSpatialRows, safeSpatialName, type SpatialContext, type SpatialModelKind } from '../shared/spatialContext'
import type { ModelConfig, ModelFitInput, ModelParamValue, ModelPlugin, ModelResult, ModelResultTable } from '../types'
...
const safeName = safeSpatialName
